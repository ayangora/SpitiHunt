...
<body >
  ...
  <main id="main" >
    ...
    <br/>
      <br/>  <br/>  <br/>  <br/>
	    <div class = "container trp" style="background-color: #f3f8fa;width: 340px;">

    <form>
    <br/>
      <div class="form-group">
      <label for="user"><strong> Username</strong></label>
      <input type="password" class="form-control" placeholder="ex: narayanara12" id="username" style="width: 300px;">
    </div>
      <div class="form-group">
      <label for="pwd"><strong> Password</strong></label>
      <input type="password" class="form-control" placeholder="ex: test123" id="password" style="width: 300px;">
   <br/>
    </div>
